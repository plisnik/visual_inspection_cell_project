...
# EYE-IN-HAND: CAMERA MOUNTED ON ROBOT
# Define path to the temporary_data_set folder and its subfolders
...
T_cam2grip: np.ndarray = np.eye(4)
...
T_grip2cam_W: np.ndarray = np.eye(4)
...
T_cam2grip_W: np.ndarray = np.linalg.inv(T_grip2cam_W)
print(T_cam2grip_W)
