...
scale_factor = 0.65  # factor for rectangle in image
distance = 0.33      # in meters
# ============================================

def main():
    """
    Main function for automatic robot calibration data collection using RTDE interfaces.

    This function orchestrates the complete automatic calibration data collection process including:
    ...
    5. Creating dataset directories and saving pose/joint data for each calibration point
    ...
    Notes:
        ...
        - Eye-in-hand uses multiple circle point sets for better coverage
    ...
    if calib_config == 0:
        ...
        # Combine lists: origin point + valid camera positions + circular points (two sets)
